...
public class Order {
    ...
    public static Order createOrder(User staff, CoffeeTable table, List<OrderDetail> cart) {
        ...
        if (!staff.isStaff() && !staff.isManager()) {
            System.out.println("Lỗi: Bạn không có quyền tạo Order!");
            return null;
        }
        ...
        if (!table.isAvailableForOrder()) {
            System.out.println("Lỗi: Bàn " + table.getTableName() + " đang " + table.getStatus() + ", không thể tạo Order");
            return null;
        }
        ...
        System.out.println("Thông báo: Tạo Order thành công.");
        return newOrder;
    }
